...
public class TransactionManager {
  ...
  // (even if that's made through getters and setters), the ideal scenerio for this application,
  ...
  // the changes on the variable states, would only occur inside the ownee class
